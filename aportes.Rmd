...
title: "Aportes"
description: |
  Formas de contribuir a un proyecto abierto y gratuito
...
Diseñar y armar todo el material fue (y es) un trabajo arduo, basado en el compromiso de brindar más y mejor conocimiento sobre el lenguaje de programación R para el análisis de información estadística. La propuesta es fomentar el uso de este software de programación para toda aquella persona que no viene de la programación, de sistemas o con un background fuerte en estos mundos.
